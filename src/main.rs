...
fn main() {
    ...
    ispace(seed, topleft, bottomright, bound, size, iterate);
}

#[allow(dead_code)]
fn ispace(c: Comp, topleft: Comp, bottomright: Comp, bound: f64, size: u32, iterate: usize) {

    let path = Path::new("./plots/icurrent.npxl");
    ...
    let rstep: f64 = (bottomright.r - topleft.r) / size as f64;
    let istep: f64 = (topleft.i - bottomright.i) / size as f64;
